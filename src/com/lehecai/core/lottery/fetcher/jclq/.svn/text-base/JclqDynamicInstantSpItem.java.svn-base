 ...
 * 浮动奖金即时sp 抓取对象
 */
public class JclqDynamicInstantSpItem {
	...
	private Map<JclqSPType, String> spmap; //即时sp
	...
	public Map<JclqSPType, String> getSpmap() {
		return spmap;
	}
	public void setSpmap(Map<JclqSPType, String> spmap) {
		this.spmap = spmap;
	}
}

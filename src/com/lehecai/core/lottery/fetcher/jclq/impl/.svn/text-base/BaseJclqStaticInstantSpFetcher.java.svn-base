...
import com.lehecai.core.lottery.fetcher.jclq.IJclqStaticInstantSpFetcher;
 ...
 *
 */
public abstract class BaseJclqStaticInstantSpFetcher implements IJclqStaticInstantSpFetcher {
	
	protected final Logger logger = LoggerFactory.getLogger(this.getClass().getName());

	@SuppressWarnings("unchecked")
	@Override
	public List<JclqStaticInstantSpItem> fetch(String officialDate, FetcherType fetcherType, LotteryType lotteryType) throws UnsupportedFetcherTypeException{
		...
		try {
			return (List<JclqStaticInstantSpItem>) m.invoke(this, o);
		} catch (Exception e) {
			logger.error(e.getMessage(), e);
			return null;
		}
	...
	@Override
	public List<JclqStaticInstantSpItem> fetch(String officialDate, LotteryType lotteryType) throws UnsupportedFetcherTypeException{
		return fetch(officialDate, getDefaultFetcherType(), lotteryType);
	}

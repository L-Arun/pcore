...
/**
 * 基础竞彩足球猜冠军赛程抓取，抽象，待具体实现
 *
 */
public abstract class BaseJczqChampionScheduleFetcher implements IJczqChampionScheduleFetcher {
	
	protected final Logger logger = LoggerFactory.getLogger(this.getClass().getName());

	@SuppressWarnings("unchecked")
	@Override
	public List<JczqChampionScheduleItem> fetch(String phase, FetcherType fetcherType) throws UnsupportedFetcherTypeException, FetchFailedException {
		...
		try {
			return (List<JczqChampionScheduleItem>) m.invoke(this, o);
	...
	@Override
	public List<JczqChampionScheduleItem> fetch(String phase) throws UnsupportedFetcherTypeException, FetchFailedException {
		return fetch(phase, getDefaultFetcherType());
	}

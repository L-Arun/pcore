 ...
 * 燕赵风采网 开奖结果抓取
 * 抓取排列7  <br/>
 * 历史地址:http://www.yzfcw.com/cade/p7/p7hitoryanalyse100.html  <br/>
 * @author liurd
 *
 */
public class LotteryDrawFetch513WorkerOfficial extends AbstractLotteryDrawFetchWorker {

	protected final Logger logger = LoggerFactory.getLogger(this.getClass().getName());
	protected static final String RESULT_LOCALITY_URL = "http://www.yzfcw.com/xml/prize.xml";
	protected static final String RESULT_MORE_LOCALITY_URL = "http://www.yzfcw.com/cade/p7/p7hitoryanalyse100.html";
	
	protected String siteName = "燕赵风采网";
	protected String lotteryScope = "排列7";
	
	public LotteryDrawFetch513WorkerOfficial() {
		super(LotteryType.A_YZFCPL7);
	}

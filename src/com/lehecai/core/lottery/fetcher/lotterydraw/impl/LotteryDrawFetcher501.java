...
import com.lehecai.core.lottery.fetcher.lotterydraw.impl.worker.LotteryDrawFetch501WorkerOfficial;
import com.lehecai.core.util.CoreFetcherUtils;

public class LotteryDrawFetcher501 extends BaseLotteryDrawFetcher {

	protected LotteryDraw fetchOfficial(String phase) {
		AbstractLotteryDrawFetchWorker fetchWorker = new LotteryDrawFetch501WorkerOfficial();

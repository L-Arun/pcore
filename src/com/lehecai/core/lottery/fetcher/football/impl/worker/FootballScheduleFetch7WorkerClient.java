 ...
 *
 */
public class FootballScheduleFetch7WorkerClient extends AbstractFootballScheduleFetchWorker {
	...
	public List<FootballScheduleItem> fetchFootballSchedule(String phase) {
		...
		List<String> result;
		try {
			result = CoreHttpUtils.postUrl(this.getScheduleUrl(), "action=getSfpMatch&phase=" + phase, CharsetConstant.CHARSET_UTF8, QueueConstant.HTTP_TIME_OUT_DEFAULT);
		} catch (IOException e) {

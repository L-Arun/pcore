 ...
 *
 */
public class FootballScheduleFetch7WorkerOfficial extends AbstractFootballScheduleFetchWorker{
	protected final Logger logger = LoggerFactory.getLogger(this.getClass().getName());
	
	protected final static String BQC_SCHEDULE_FETCH_URL_OFFICIAL = "http://www.lottery.gov.cn/lottery/sfc/SFC.aspx";

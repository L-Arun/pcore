...
/**
 * 4场进球 平均欧赔  500Wan 抓取worker
 * @author 唐容
 *
 */
public class FootballAverageSPFetch9Worker500Wan extends
...
protected final Logger logger = LoggerFactory.getLogger(this.getClass().getName());
	...
	protected String AverageSP_URL_500Wan = "http://trade.500wan.com/static/public/jq4/daigou/shtml/%s.shtml";
			...
			if( nodeList != null && nodeList.size() > 0){
				...
				while(itr.hasMoreNodes()){
					...
					if( ulTag.getAttribute("class")!=null && ulTag.getAttribute("class").indexOf("iframe_tr") >= 0){
						...
						mathIndexStr = mathIndexStr.substring(0,mathIndexStr.indexOf("."));

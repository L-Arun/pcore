...
import com.lehecai.core.lottery.fetcher.lotterydraw.impl.worker.LotteryDrawFetch551WorkerOfficial;
import com.lehecai.core.util.CoreFetcherUtils;

public class LotteryDrawFetcher551 extends BaseLotteryDrawFetcher {

	protected LotteryDraw fetchOfficial(String phase) {
		AbstractLotteryDrawFetchWorker fetchWorker = new LotteryDrawFetch551WorkerOfficial();

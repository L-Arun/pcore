...
import com.lehecai.core.lottery.fetcher.lotterydraw.impl.worker.LotteryDrawFetch543WorkerOfficial;
import com.lehecai.core.util.CoreFetcherUtils;

public class LotteryDrawFetcher543 extends BaseLotteryDrawFetcher {

	private static final LotteryType lotteryType = LotteryType.BJKL8;
	
	protected LotteryDraw fetchOfficial(String phase) {
		
		AbstractLotteryDrawFetchWorker fetchWorker = new LotteryDrawFetch543WorkerOfficial(lotteryType);

...
import com.lehecai.core.lottery.fetcher.lotterydraw.impl.worker.LotteryDrawFetch513WorkerOfficial;
import com.lehecai.core.util.CoreFetcherUtils;

public class LotteryDrawFetcher513 extends BaseLotteryDrawFetcher {	
	@Override
	protected FetcherType getDefaultFetcherType() {
		return FetcherType.T_OFFICIAL;
	}
	protected LotteryDraw fetchOfficial(String phase) {
		AbstractLotteryDrawFetchWorker fetchWorker = new LotteryDrawFetch513WorkerOfficial();

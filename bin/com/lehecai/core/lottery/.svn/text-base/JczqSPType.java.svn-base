...
public class JczqSPType extends IntegerBeanLabelItem {
	...
	//让球胜平负
	public static final JczqSPType SPF_S = new JczqSPType("让球胜平负-主队胜", 1, LotteryType.JCZQ_SPF);
	public static final JczqSPType SPF_P = new JczqSPType("让球胜平负-主队平", 2, LotteryType.JCZQ_SPF);
	public static final JczqSPType SPF_F = new JczqSPType("让球胜平负-主队负", 3, LotteryType.JCZQ_SPF);
	...
	//猜冠军
	public static final JczqSPType GJ = new JczqSPType("冠军", 53, LotteryType.JCZQ_GJ);
	//猜冠亚军
	public static final JczqSPType GYJ = new JczqSPType("冠亚军", 54, LotteryType.JCZQ_GYJ);
	...
	static {
		...
		lotteryConstantMap.put(JczqSPType.GJ, LotteryConstant.JCZQ_GJ_VALUE);
		lotteryConstantMap.put(JczqSPType.GYJ, LotteryConstant.JCZQ_GYJ_VALUE);
	}

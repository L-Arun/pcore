 ...
 * 
 */
package com.lehecai.core.bean.common;
...
public class Time {
	...
	public String toString() {
		...
		sb.append(StringUtils.leftPad(String.valueOf(hour), 2, "0")).append(":").append(StringUtils.leftPad(String.valueOf(minute), 2, "0"));
		if (second == 0) {
			if (millisecond > 0) {
				sb.append(":").append(StringUtils.leftPad(String.valueOf(second), 2, "0")).append(".").append(StringUtils.leftPad(String.valueOf(millisecond), 3, "0"));
			}
		} else {
			sb.append(":").append(StringUtils.leftPad(String.valueOf(second), 2, "0"));
			if (millisecond > 0) {
				sb.append(".").append(StringUtils.leftPad(String.valueOf(millisecond), 3, "0"));
			}
		}
		return sb.toString();
	}

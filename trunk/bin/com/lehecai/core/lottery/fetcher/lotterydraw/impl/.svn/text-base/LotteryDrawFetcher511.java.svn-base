...
import com.lehecai.core.lottery.fetcher.lotterydraw.impl.worker.LotteryDrawFetch511WorkerOfficial;
import com.lehecai.core.util.CoreFetcherUtils;

public class LotteryDrawFetcher511 extends BaseLotteryDrawFetcher {

	protected LotteryDraw fetchOfficial(String phase) {
		AbstractLotteryDrawFetchWorker fetchWorker = new LotteryDrawFetch511WorkerOfficial();

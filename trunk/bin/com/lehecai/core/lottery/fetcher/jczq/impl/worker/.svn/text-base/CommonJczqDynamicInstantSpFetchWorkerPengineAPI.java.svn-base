 ...
 *
 */
public class CommonJczqDynamicInstantSpFetchWorkerPengineAPI extends AbstractJczqDynamicInstantSpFetchWorker{
	...
	public List<JczqDynamicInstantSpItem> fetchJczqSp(String officialDate, LotteryType lotteryType){

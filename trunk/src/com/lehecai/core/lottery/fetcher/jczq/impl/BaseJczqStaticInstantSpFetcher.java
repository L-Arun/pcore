...
import com.lehecai.core.lottery.fetcher.jczq.IJczqStaticInstantSpFetcher;
 ...
 *
 */
public abstract class BaseJczqStaticInstantSpFetcher implements IJczqStaticInstantSpFetcher {
	...
	public List<JczqStaticInstantSpItem> fetch(String officialDate, FetcherType fetcherType, LotteryType lotteryType) throws UnsupportedFetcherTypeException{
		...
		try {
			return (List<JczqStaticInstantSpItem>) m.invoke(this, o);
		} catch (Exception e) {
			logger.error(e.getMessage(), e);
			return null;
		}

 ...
 *
 */
public class LotteryDrawFetcher555 extends BaseLotteryDrawFetcher{

	public LotteryDraw fetchOfficial(String phase) {
		AbstractLotteryDrawFetchWorker fetchWorker = new LotteryDrawFetchWorkerGDFC(LotteryType.A_NYFCHC1);

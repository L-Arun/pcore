...
/**
 * 14场 足球赛程 500WanWeb 抓取worker
 * @author liurd
 *
 */
public class FootballScheduleFetch7Worker500WanWeb extends AbstractFootballScheduleFetchWorker{
	...
	protected final static String BQC_SCHEDULE_FETCH_URL_500WAN = "http://zc.trade.500wan.com/sfc/index.php";

...
import com.lehecai.core.lottery.fetcher.lotterydraw.impl.LotteryDrawFetcher553;

public class Fetcher553Test {
	private static final Logger logger = LoggerFactory.getLogger(Fetcher553Test.class.getName());
	
	public static void main(String [] args) {
		try{
			logger.info("==========抓取 好运彩2开始");
			ILotteryDrawFetcher fetcher = new LotteryDrawFetcher553();

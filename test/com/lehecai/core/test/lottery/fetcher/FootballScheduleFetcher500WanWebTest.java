...
public class FootballScheduleFetcher500WanWebTest {
	...
	public static void main(String[] args){
		try{
			...
			List<FootballScheduleItem> footballScheduleItems5 = footballScheduleFetcher10.fetch500WanWeb(null);
			List<FootballScheduleItem> footballScheduleItems6 = footballScheduleFetcher10.fetch500WanWeb("11083");
			...
			List<FootballScheduleItem> footballScheduleItems3 = footballScheduleFetcher9.fetch500WanWeb(null);
			List<FootballScheduleItem> footballScheduleItems4 = footballScheduleFetcher9.fetch500WanWeb("11044");
			...
			List<FootballScheduleItem> footballScheduleItems1 = footballScheduleFetcher7.fetch500WanWeb(null);
			List<FootballScheduleItem> footballScheduleItems2 = footballScheduleFetcher7.fetch500WanWeb("11044");
